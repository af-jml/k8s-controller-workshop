...
func loadConfig() config {
	return config{
		...
		MockAIURL:      envOrDefault("MOCK_AI_URL", "http://mock-ai.workshop.svc.cluster.local:8080"),
		MinioEndpoint:  envOrDefault("MINIO_ENDPOINT", "minio.workshop.svc.cluster.local:9000"),
